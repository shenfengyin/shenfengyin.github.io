...
tags:
  ...
  - "hexo"
  - "butterfly"
recovery_source: "https://shenfengyin.github.io/2023/10/04/hexo-building-blog/"
recovery_branch: "old_main"
---
使用hexo搭建离线博客
...
风吟搭建的时候用的是mac，windows的话也建议用虚拟机搭建环境，上述安装步骤如下

1.  git安装、github创建新仓库  
    `仓库名必须为<username>.github.io`  
    `eg: 风吟这里用的是shenfengyin.github.io`  
    ![](image1.png)
2.  hexo安装  
...
4.  主题butterfly介绍  
    ...
    其他主题也很不错，这里风吟用butterfly作为博客主题，大家可以去hexo官网上搜索合适的themes。  
...
7.  后续完善  
    ...
    特别的，注意页面配置和文章页配置，有时间的话，风吟会出一期说明，但是参考一下文档收获更多：  
